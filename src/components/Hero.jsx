          ...
          <div className="bento-card flex items-center justify-center py-8 md:py-12 order-first md:order-last">
            <div className="relative" ref={avatarRef}>
              ...
              <a
                ...
                className={`relative block w-44 h-44 md:w-56 md:h-56 lg:w-72 lg:h-72 rounded-full overflow-hidden border-[3px] p-2 bg-paper no-underline focus:outline-none transition-all duration-300 ${auraActive ? 'border-sky shadow-[0_0_30px_rgba(122,154,184,0.5)]' : 'border-cloud shadow-[0_4px_20px_rgba(35,30,26,0.15)]'}`}
              ...
              {auraActive && (
                <div className="absolute bottom-[17%] left-1/2 -translate-x-1/2 md:bottom-[14%] md:left-auto md:translate-x-0 md:right-[46%] pointer-events-none">
