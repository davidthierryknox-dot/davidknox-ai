        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-24 items-center">
          ...
          <div className="flex justify-center items-center order-first md:order-last">
            <div className="relative" ref={avatarRef}>
              ...
              {auraActive && (
                <div className="absolute bottom-[18%] right-[40%] md:bottom-[12%] md:right-[42%] animate-fade-in pointer-events-none">
                  <svg className="w-5 h-5 md:w-6 md:h-6 lg:w-8 lg:h-8" viewBox="0 0 24 24" fill="#0A66C2">
